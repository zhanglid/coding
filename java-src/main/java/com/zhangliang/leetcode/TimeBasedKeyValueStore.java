    ...
    static class TimeMap {
        class TimeValues {
            ...
            public String get(int timestamp) {
                ...
                if (timestampList.get(r) <= timestamp) {
                    return valueList.get(r);
                }
                if (timestampList.get(l) <= timestamp) {
        ...
        public void set(String key, String value, int timestamp) {
            if (!cache.containsKey(key)) {
                cache.put(key, new TimeValues());
            }
            cache.get(key).add(timestamp, value);
        }
        ...
        public String get(String key, int timestamp) {
            ...
            TimeValues tv = cache.get(key);
            return tv.get(timestamp);
        }
    }
}
