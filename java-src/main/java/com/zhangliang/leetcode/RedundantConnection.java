...
public class RedundantConnection {
    private void connect(int[] fathers, int a, int b) {
    ...
    private boolean isConnected(int[] fathers, int a, int b) {
        int rootA = find(fathers, a);
        int rootB = find(fathers, b);
    ...
    private int find(int[] fathers, int a) {
        ...
        int root = find(fathers, fathers[a]);
        fathers[a] = root;
        return root;
    }
