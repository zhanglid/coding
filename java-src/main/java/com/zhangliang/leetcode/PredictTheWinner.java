...
Explanation: Player 1 first chooses 1. Then player 2 have to choose between 5 and 7. No matter which
 number player 2 choose, player 1 can choose 233. Finally, player 1 has more score (234) than 
 player 2 (12), so you need to return True representing 
player1 can win.
Note:
...
public class PredictTheWinner {
    public boolean PredictTheWinner(int[] nums) {
        ...
        /*
            dp[i][j]: [i...j] maximum win number over
