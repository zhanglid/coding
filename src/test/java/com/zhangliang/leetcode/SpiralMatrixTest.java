...
public class SpiralMatrixTest {
    ...
    public void errCase() {
        ...
        Integer[] ans = s
                ...
                .toArray(new Integer[0]);
        assertArrayEquals(new Integer[] { 1, 2, 3, 4, 8, 12, 16, 15, 14, 13, 9, 5, 6, 7, 11, 10 }, ans);
    }

    @Test
    public void errCase2() {
        SpiralMatrix s = new SpiralMatrix();
        Integer[] ans = s.spiralOrder(new int[][] {}).toArray(new Integer[0]);
        assertArrayEquals(new Integer[] {}, ans);
    }
}
